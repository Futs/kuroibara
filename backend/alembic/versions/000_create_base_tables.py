...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "alternative_titles", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column("cover_image", sa.String(length=255), nullable=True),
        sa.Column(
            "type",
            sa.Enum("MANGA", "MANHUA", "MANHWA", "COMIC", "UNKNOWN", name="mangatype"),
            nullable=False,
        ),
        sa.Column(
            "status",
        ...
        sa.Column(
            "external_ids", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_manga_external_id"), "manga", ["external_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "alternative_names", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_chapter_external_id"), "chapter", ["external_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_manga_user_library_id"), "manga_user_library", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "manga_user_library_id", postgresql.UUID(as_uuid=True), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_reading_progress_id"), "reading_progress", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_provider_status_id"), "provider_status", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_provider_status_provider_id"),
        "provider_status",
        ["provider_id"],
        unique=True,
    )
