...
def upgrade():
    ...
    op.create_index(
        op.f("ix_manga_metadata_id"), "manga_metadata", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_chapter_metadata_id"), "chapter_metadata", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "errors_encountered", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "operation_details", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["chapter_id"],
            ["chapter.id"],
    ...
    op.create_index(
        op.f("ix_organization_history_id"), "organization_history", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_organization_jobs_id"), "organization_jobs", ["id"], unique=False
    )
