...
def upgrade() -> None:
    ...
    try:
        op.add_column(
            "chapter",
            sa.Column("provider_external_ids", postgresql.JSONB(), nullable=True),
        )
    ...
    try:
        op.add_column(
            "chapter",
            sa.Column("fallback_providers", postgresql.JSONB(), nullable=True),
        )
    ...
    try:
        op.create_index(
            "ix_chapter_provider_external_ids",
            "chapter",
