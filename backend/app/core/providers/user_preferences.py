...
def prioritize_providers_by_user_preferences(
    ...
    user_preferences: Dict[str, UserProviderPreference]
...
def apply_fallback_prioritization(providers: List[BaseProvider]) -> Tuple[List[BaseProvider], List[BaseProvider]]:
    """
