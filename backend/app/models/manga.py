...
from sqlalchemy import Boolean, Column, String, Text, Integer, ForeignKey, Table, Enum
...
class Manga(BaseModel):
    ...
    user_libraries = relationship("MangaUserLibrary", back_populates="manga", cascade="all, delete-orphan")
...
class Chapter(BaseModel):
    ...
    reading_progress = relationship("ReadingProgress", back_populates="chapter", cascade="all, delete-orphan")
