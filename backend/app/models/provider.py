...
class ProviderStatus(BaseModel):
    ...
    status = Column(String(20), default=ProviderStatusEnum.UNKNOWN.value, nullable=False)
    ...
    def is_healthy(self) -> bool:
        ...
        return (
            self.status == ProviderStatusEnum.ACTIVE.value and
    ...
    def update_status(self, is_success: bool, response_time: int = None, error_message: str = None):
        ...
        if self.total_checks > 0:
            self.uptime_percentage = int((self.successful_checks / self.total_checks) * 100)
