...
async def test_basic_functionality():
    ...
    expected_caps = ['search', 'manga_details', 'chapters', 'pages', 'download_page', 'download_cover', 'health_check']
    ...
    expected_selectors = [
        'search_results', 'manga_title', 'manga_description', 
        'manga_cover', 'chapters', 'pages'
    ]
...
async def test_error_handling():
    ...
    try:
        ...
        logger.info(f"✅ Invalid manga details properly raises exception: {type(e).__name__}")
    ...
    try:
        ...
        logger.info(f"✅ Invalid chapters properly raises exception: {type(e).__name__}")
