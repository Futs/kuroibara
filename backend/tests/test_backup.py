...
class TestBackupService:
    ...
    def setup_method(self):
        ...
        # Update the derived directories
    ...
    def test_list_backups(self):
        ...
        if os.path.exists(self.service.backups_dir):
            for file in os.listdir(self.service.backups_dir):
                if file.endswith(".tar.gz"):
                    os.remove(os.path.join(self.service.backups_dir, file))
