...
class TestStorageRecoveryService:
    ...
    def test_extract_chapter_info_from_filename(self):
        ...
        result = self.service._extract_chapter_info_from_filename("1 - Enter Sasuke!.cbz")
        assert result["number"] == "1"
        assert result["title"] == "Enter Sasuke!"
        assert result["filename"] == "1 - Enter Sasuke!.cbz"
        
        # Test decimal chapter number
        result = self.service._extract_chapter_info_from_filename("12.5 - Special Chapter.cbz")
    ...
    def test_natural_sort_key(self):
        ...
        assert self.service._natural_sort_key("1") < self.service._natural_sort_key("10")
        assert self.service._natural_sort_key("1.5") < self.service._natural_sort_key("2")
    ...
    async def test_recover_manga_to_database(self):
        ...
        with patch('app.core.services.storage_recovery.get_manga_storage_path') as mock_get_path:
    ...
    def test_scan_volume_for_chapters(self):
        ...
        # Create test CBZ files
        chapters = ["1 - Chapter One.cbz", "2 - Chapter Two.cbz", "10 - Chapter Ten.cbz"]
