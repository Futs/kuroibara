<template>
  <div
    class="provider-summary-card bg-white dark:bg-dark-800 shadow rounded-lg overflow-hidden"
  >
    <!-- Provider Header -->
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-3">
          ...
          <div class="flex-shrink-0">
            <div
              class="h-12 w-12 rounded-lg bg-primary-100 dark:bg-primary-900 flex items-center justify-center"
            >
              <svg
    ...
    <!-- Actions -->
    <div
      class="px-6 py-4 bg-gray-50 dark:bg-dark-700 border-t border-gray-200 dark:border-dark-600"
    >
