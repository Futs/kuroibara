  ...
  <div class="reading-stats bg-white dark:bg-dark-800 rounded-lg shadow-lg p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      ...
      <div class="stat-card bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
        <div class="flex items-center">
          <div class="text-purple-600 dark:text-purple-400 text-2xl mr-3">
            🔥
          </div>
          <div>
            <div
      ...
      <div class="stat-card bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg">
        <div class="flex items-center">
          <div class="text-orange-600 dark:text-orange-400 text-2xl mr-3">
            🏆
          </div>
          <div>
            <div
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <div class="flex items-start">
            <div
              class="text-2xl mr-3"
              :class="{ grayscale: !isUnlocked(achievement.id) }"
            >
              {{ achievement.icon }}
            </div>
            <div class="flex-1">
              ...
              <div
                ...
                class="w-full bg-gray-200 dark:bg-dark-600 rounded-full h-2"
              >
                <div
