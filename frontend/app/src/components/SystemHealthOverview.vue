        ...
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">
              ...
              <span
                v-if="healthData.components?.database?.response_time_ms"
                class="text-xs"
              >
      ...
      <div class="bg-white dark:bg-dark-800 rounded-lg shadow p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">
              {{ healthData.components?.indexers?.healthy_count || 0 }}/{{
                healthData.components?.indexers?.total_count || 0
              }}
              healthy
            </p>
          </div>
      ...
      <div class="bg-white dark:bg-dark-800 rounded-lg shadow p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">
              {{ healthData.components?.providers?.enabled_count || 0 }}/{{
                healthData.components?.providers?.total_count || 0
              }}
              enabled
            </p>
          </div>
