<template>
  <div
    class="volume-download-card bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-600 rounded-lg p-4"
  >
    <div class="flex items-center justify-between">
      ...
      <div class="flex-1">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
          ...
          <span v-if="volume.language" class="ml-2"
            >• {{ formatLanguage(volume.language) }}</span
          >
        </p>
    ...
    <div
      v-if="showChapters"
      class="mt-4 border-t border-gray-200 dark:border-dark-600 pt-4"
    >
      <div class="space-y-2">
        <div
...
const downloadedCount = computed(() => {
  return props.volume.chapters.filter(
...
const downloadProgress = computed(() => {
  ...
  return Math.round(
    (downloadedCount.value / props.volume.chapters.length) * 100,
  );
});
...
const isPartiallyDownloaded = computed(() => {
  return (
    ...
    downloadedCount.value < props.volume.chapters.length
  );
});

const hasErrors = computed(() => {
  return props.volume.chapters.some(
