...
describe('Security Store', () => {
  ...
  describe('Role Management', () => {
    ...
    it('should throw error for invalid role', async () => {
      await expect(securityStore.setUserRole('invalid_role')).rejects.toThrow('Invalid role: invalid_role');
    });
    ...
    it('should require permission correctly', () => {
      ...
      expect(() => securityStore.requirePermission('library.read')).not.toThrow();
      expect(() => securityStore.requirePermission('users.manage')).toThrow('Access denied: Missing permission \'users.manage\'');
    });
  });
  ...
  describe('Content Filtering', () => {
    ...
    it('should filter content based on blocked tags', () => {
      ...
      const content1 = { rating: 'PG', isNSFW: false, tags: ['comedy'], language: 'en' };
      const content2 = { rating: 'PG', isNSFW: false, tags: ['violence'], language: 'en' };
    ...
    it('should filter content based on language', () => {
      ...
      const content1 = { rating: 'PG', isNSFW: false, tags: [], language: 'en' };
      const content2 = { rating: 'PG', isNSFW: false, tags: [], language: 'fr' };
    ...
    it('should update content filter correctly', async () => {
      ...
      expect(mockApi.put).toHaveBeenCalledWith('/user/content-filter', expect.objectContaining(newFilter));
    });
  });
  ...
  describe('Session Management', () => {
    ...
    it('should terminate all other sessions', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/auth/sessions/terminate-others');
    });
  });
  ...
  describe('Two-Factor Authentication', () => {
    it('should enable two-factor authentication', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/auth/2fa/enable', { method: 'totp' });
    });
    ...
    it('should disable two-factor authentication', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/auth/2fa/disable', { code: '123456' });
    });
    ...
    it('should verify two-factor code', async () => {
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/auth/2fa/verify', { code: '123456' });
    });
  });
