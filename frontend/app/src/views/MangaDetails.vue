  ...
  <div class="manga-details">
    ...
    >
      ...
      >
        ...
        <span>{{ newChaptersCount }} new chapter{{ newChaptersCount > 1 ? 's' : '' }} available!</span>
        <button
      ...
      <div class="p-4 sm:p-6">
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="mt-4 space-y-3">
              ...
              <button
                v-if="
                  ...
                  (libraryItemDetails && libraryItemDetails.chapters && libraryItemDetails.chapters.length > 0)
                "
                @click="startReading"
                class="w-full flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
              >
              ...
              <button
                v-if="!isExternal && inLibrary && manga.provider && manga.external_id"
                @click="downloadManga"
          ...
          <div class="w-full md:w-2/3 lg:w-3/4">
            ...
            <!-- Chapters -->
            <div v-if="(manga.chapters && manga.chapters.length) || (providerChapters && providerChapters.length)" class="mt-6">
              <div class="flex items-center justify-between">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white">
                  Chapters ({{ (providerChapters && providerChapters.length) ? providerChapters.length : (manga.chapters ? manga.chapters.length : 0) }})
                </h3>
                <div class="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    :title="lastUpdateTime ? `Last updated: ${formatDate(lastUpdateTime)}` : 'Refresh chapter list'"
                  >
                    <svg
              ...
              <div class="mt-2 border-t border-gray-200 dark:border-dark-600">
                ...
                <ul
                  v-else-if="
                    ...
                    sortedEnhancedChapters && sortedEnhancedChapters.length > 0
                  "
                  role="list"
                ...
                <div v-else-if="!isExternal && libraryItemDetails && viewMode === 'chapters' && providerChapters && providerChapters.length">
                  <!-- Pagination Info -->
                  <div class="flex justify-between items-center mb-4">
                    <p class="text-sm text-gray-700 dark:text-gray-300">
                      Showing {{ paginationInfo.start }}-{{ paginationInfo.end }} of {{ paginationInfo.total }} chapters
                    </p>
                  ...
                  >
                    <div class="flex items-center">
                      ...
                      <div class="flex-1">
                        ...
                        <div class="flex items-center space-x-3 mt-1">
                          <p
                            v-if="chapter.publish_at || chapter.readable_at || chapter.upload_date || chapter.release_date || chapter.created_at || chapter.updated_at"
                            class="text-xs text-gray-500 dark:text-gray-400"
                          >
                            📅 {{ formatDate(chapter.publish_at || chapter.readable_at || chapter.upload_date || chapter.release_date || chapter.created_at || chapter.updated_at) }}
                          </p>
                          <p
                    ...
                    <div class="flex items-center space-x-2">
                      ...
                      <button
                        v-if="chapter.download_status === 'downloaded' && chapter.library_chapter_id"
...
const autoRefreshInterval = computed(() => settingsStore.getChapterAutoRefreshInterval);
const checkOnTabFocus = computed(() => settingsStore.getChapterCheckOnTabFocus);
const showUpdateNotifications = computed(() => settingsStore.getChapterShowUpdateNotifications);
const enableManualRefresh = computed(() => settingsStore.getChapterEnableManualRefresh);
...
const paginationInfo = computed(() => {
  ...
  const end = Math.min(currentPage.value * chaptersPerPage, sortedProviderChapters.value.length);
...
const getChapterScore = (chapter) => {
  ...
  if (chapter.upload_date || chapter.release_date || chapter.created_at || chapter.updated_at) score += 1; // Other dates
