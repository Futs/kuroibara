  ...
  <div class="manga-reader" :class="{ 'dark': true }">
    ...
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between">
        <div class="flex items-center space-x-4">
          ...
          <div class="text-sm sm:text-base font-medium text-gray-900 dark:text-white truncate">
            {{ manga?.title }}
          </div>
        </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between border-t border-gray-200 dark:border-dark-700">
        <div class="flex items-center space-x-4">
          <button 
            @click="prevChapter" 
          ...
          <div class="relative">
            ...
            >
              <div class="py-1 max-h-60 overflow-y-auto" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                <button 
                  ...
                  :class="{ 'bg-gray-100 dark:bg-dark-700': chap.id === chapter?.id }"
                  role="menuitem"
                >
                  {{ chap.title }}
                </button>
    ...
    >
      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 bg-gray-500 dark:bg-dark-900 bg-opacity-75 dark:bg-opacity-75 transition-opacity"></div>
            ...
            <div class="mt-3 text-center sm:mt-0 sm:text-left">
              ...
              <div class="mt-4 space-y-4">
                <div>
                  ...
                  <div class="mt-2 flex space-x-2">
                    <button 
                      ...
                      :class="settings.readingDirection === 'rtl' ? 'bg-primary-600 text-white border-primary-600' : 'border-gray-300 dark:border-dark-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-dark-800'"
                    >
                      Right to Left
                    </button>
                    <button 
                      ...
                      class="px-3 py-2 border rounded-md text-sm font-medium"
                      :class="settings.readingDirection === 'ltr' ? 'bg-primary-600 text-white border-primary-600' : 'border-gray-300 dark:border-dark-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-dark-800'"
                    >
                      Left to Right
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <div class="mt-2 flex space-x-2">
                    <button 
                      ...
                      class="px-3 py-2 border rounded-md text-sm font-medium"
                      :class="settings.pageLayout === 'single' ? 'bg-primary-600 text-white border-primary-600' : 'border-gray-300 dark:border-dark-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-dark-800'"
                    >
                      Single Page
                    </button>
                    <button 
                      ...
                      class="px-3 py-2 border rounded-md text-sm font-medium"
                      :class="settings.pageLayout === 'double' ? 'bg-primary-600 text-white border-primary-600' : 'border-gray-300 dark:border-dark-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-dark-800'"
                    >
                      Double Page
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <div class="mt-2 flex space-x-2">
                    <button 
                      ...
                      class="px-3 py-2 border rounded-md text-sm font-medium"
                      :class="settings.fitMode === 'width' ? 'bg-primary-600 text-white border-primary-600' : 'border-gray-300 dark:border-dark-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-dark-800'"
                    >
                      Fit Width
                    </button>
                    <button 
                      ...
                      class="px-3 py-2 border rounded-md text-sm font-medium"
                      :class="settings.fitMode === 'height' ? 'bg-primary-600 text-white border-primary-600' : 'border-gray-300 dark:border-dark-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-dark-800'"
                    >
                      Fit Height
                    </button>
                    <button 
                      ...
                      class="px-3 py-2 border rounded-md text-sm font-medium"
                      :class="settings.fitMode === 'both' ? 'bg-primary-600 text-white border-primary-600' : 'border-gray-300 dark:border-dark-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-dark-800'"
                    >
                      Fit Both
                    </button>
                  </div>
                ...
                <div class="flex items-center justify-between">
                  ...
                  <button 
                    @click="updateSettings({ showPageNumbers: !settings.showPageNumbers })" 
                    ...
                    :class="settings.showPageNumbers ? 'bg-primary-600' : 'bg-gray-200 dark:bg-dark-600'"
                  >
                    <span 
                      class="pointer-events-none inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200"
                      :class="settings.showPageNumbers ? 'translate-x-5' : 'translate-x-0'"
                    ></span>
                  </button>
                </div>
                ...
                <div class="flex items-center justify-between">
                  ...
                  <button 
                    @click="updateSettings({ autoAdvance: !settings.autoAdvance })" 
                    class="relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                    :class="settings.autoAdvance ? 'bg-primary-600' : 'bg-gray-200 dark:bg-dark-600'"
                  >
                    <span 
                      class="pointer-events-none inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200"
                      :class="settings.autoAdvance ? 'translate-x-5' : 'translate-x-0'"
                    ></span>
                  </button>
                </div>
              </div>
    ...
    >
      ...
      <div v-else-if="error" class="text-center p-4">
        <div class="inline-block p-4 bg-red-50 dark:bg-red-900 rounded-lg">
          <svg class="h-10 w-10 text-red-500 dark:text-red-400 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
